...
var MAPCanvas = {
  ...
  updateTiles: func() {
    ...
    var offset = [
      n * ((lon + 180) / 360) - me.center_tile_offset[0], (1 - math.ln(math.tan(lat * math.pi/180) + 1 / math.cos(lat * math.pi/180)) / math.pi) / 2 * n - me.center_tile_offset[1]
    ];
...
var MapCanvas = c160.MAPCanvas.new({"node": "canvasCadre", "texture": "canvasTex.png"});
